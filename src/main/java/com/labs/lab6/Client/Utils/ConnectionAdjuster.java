            ...
            switch (command.getCommand()) {
                ...
                case "connect":
                    ...
                    if (requestsSendler.sendRequest(request)) {
                        ...
                        if (ans != null) {
                            groupCounter = Integer.parseInt(ans.trim());
                            StudyGroup.setCounter(groupCounter);
                            StudyGroupCreator groupCreator = new StudyGroupCreator();

                            ConsoleManager consoleManager = new ConsoleManager(requestsSendler, responsesReceiver, groupCreator);
